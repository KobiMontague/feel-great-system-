...
@section('content')
        ...
        <div class="mx-auto max-w-7xl px-6 pt-16 pb-16 md:pt-24 md:pb-24">
            <div class="grid md:grid-cols-2 gap-10 items-center">
                <div>
                    ...
                    <h2 class="text-4xl md:text-6xl font-extrabold leading-tight mt-2">
                        Kobi Montague
                    </h2>
        ...
        <div class="mx-auto max-w-7xl px-6">
            ...
            <div class="mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center justify-center">
                <div class="bg-white rounded-2xl shadow p-4 text-center flex flex-col items-center">
                    <div class="relative w-72 h-96 rounded-xl bg-cover bg-center select-none"
                         oncontextmenu="return false;"
                         style="background-image:url('{{ asset('images/transformation/before1.jpg') }}');
            -webkit-touch-callout:none; -webkit-user-select:none; user-select:none;">
                ...
                <div class="bg-white rounded-2xl shadow p-4 text-center flex flex-col items-center">
                    <div class="relative w-72 h-96 rounded-xl bg-cover bg-center select-none"
                         oncontextmenu="return false;"
                         style="background-image:url('{{ asset('images/transformation/After5.jpg') }}');
            -webkit-touch-callout:none; -webkit-user-select:none; user-select:none;">
                        <div class="absolute inset-0" aria-hidden="true"></div>
                    </div>
                    ...
                    <div class="md:grid md:grid-cols-[110px,1fr] md:items-center md:gap-6">
                        <div class="flex justify-center md:block">
                            <div class="h-28 w-20 md:h-32 md:w-24">
                                <img src="{{ asset('images/Unicity/Unimate.png') }}" alt="Unicity Unimate" class="h-full w-full object-contain" />
                            </div>
                        </div>
                ...
                @foreach ([
                    ...
                    <div class="rounded-xl border border-slate-200 p-4 shadow-sm">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xs text-slate-500">{{ $tech }}</span>
                        </div>
                        <p class="mt-2 text-sm text-slate-700">{{ $what }}</p>
                        <p class="mt-2 text-sm text-emerald-700">Why it matters: {{ $why }}</p>
                    </div>
                @endforeach
            </div>
        ...
        <div class="mx-auto max-w-4xl px-6 text-center">
            ...
            <div class="mt-8 flex justify-center">
                <div class="bg-white p-6 rounded-2xl shadow-lg">
                    <img src="{{ asset('images/Unicity/feel-great-system-qr-code.png') }}" alt="Feel Great System QR Code" class="w-48 h-48 md:w-64 md:h-64 object-contain mx-auto">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-emerald-50">
        <div class="mx-auto max-w-6xl px-6 text-center">
            ...
            <p class="mt-3 text-slate-700">
                Become a Feel Great partner. I’ll mentor you and share resources that make getting started simple.
            </p>
            <div class="mt-6">
                <a href="{{ route('partnership') }}"
                   class="inline-flex items-center rounded-xl bg-emerald-600 px-6 py-3 text-white font-semibold shadow hover:bg-emerald-700">
            ...
            <div class="mt-6 flex justify-center gap-6">
                <a href="https://www.tiktok.com/@feel_great_system_au" target="_blank" rel="noopener"
                   class="group flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 text-slate-700 shadow hover:bg-emerald-50 hover:border-emerald-300 transition">
                    <img src="{{ asset('images/socials/tiktok-brands-solid-full.svg') }}" alt="TikTok Logo" class="h-5 w-5">
