...
@section('title', 'Science | Feel Great System')
...
@section('content')
            ...
            <div class="grid md:grid-cols-2 gap-10 items-center">
                <div>
                    ...
                    <p class="mt-4 text-lg text-slate-700">
                        ...
                        (Unimate + Balance (Bios Life S) + a 16:8 fasting window) and its effect on
                        <span class="font-semibold">glycemic variability</span>.
                    </p>
                </div>
        ...
        <div class="mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-10 items-center">
            ...
            <div class="flex justify-center">
                <img
                    ...
                    alt="University of Sydney study: blood glucose and insulin response with Bios Life"
            ...
            <div>
                ...
                <p class="mt-4 text-slate-700 leading-relaxed">
                    Researchers evaluated how the phytonutrient combination in <span class="font-semibold">Bios Life (Balance)</span> affects
    ...
    <section class="py-16 bg-white">
        <div class="mx-auto max-w-6xl px-6 text-center">
            ...
            <p class="mt-3 text-slate-700">Unimate in the morning, Balance before your largest meals, and a fasting window that fits you.</p>
